...
// looks 'good' for riso
   ...
   // metric_thread (diameter=22.1, pitch=2.5, length=9.2, thread_size=2.5, square=true, leadin=1); 
    

difference () {
   cylinder (r=12, h=9, $fn=100);
   metric_thread (diameter=23, pitch=2.8, length=9.2, thread_size=1.8);
}
...
// depth 1 mm.
//metric_thread (diameter=20, pitch=8, length=16, thread_size=6,
//               groove=true);
